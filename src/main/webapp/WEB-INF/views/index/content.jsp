...
<div class="container">
  <div id="block_feature">
    <div id="work_list">
      <div id="search">
        <form action="/search" method="post" id="search_form_id">
  ...
  <div id="block_content_up">
    <div class=" infobox" >
    	<div class="tiTou"><span>通知公告</span><a href="${pageContext.request.contextPath}/bbs/notice"></a></div>
    	<ul>
    	      <c:choose>
    ...
    <div class=" infobox" >
    	<div class="tiTou"><span>法规制度</span><a href="${pageContext.request.contextPath}/bbs/fgzd/gjzd"></a></div>
      <ul>
         <c:choose>
    ...
    <div class="infobox_right infobox" >
    	<div class="tiTou"><span>服务之窗</span><a href="${pageContext.request.contextPath}/bbs/fwzc"></a></div>
      <ul>
        <c:choose>
  ...
  <div id="block_content_down">
    <div class=" infobox" >
    	<div class="tiTou"><span>督查信息</span><a  href="${pageContext.request.contextPath}/bbs/dcxx"></a></div>
      <ul>
           <c:choose>
    ...
    <div class=" infobox" >
    	<div class="tiTou"><span>信访信息</span><a href="${pageContext.request.contextPath}/bbs/xfxx"></a></div>
      <ul>
         <c:choose>
    ...
    <div class="infobox_right infobox" >
   		<div class="tiTou"><span>下载专区</span><a href="${pageContext.request.contextPath}/bbs/xzzq"></a></div>
      <ul>
        <c:choose>
