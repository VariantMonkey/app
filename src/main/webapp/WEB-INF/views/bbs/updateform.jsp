...
<input type="button" value="bbs列表" class="buttonStyle"
...
<div class="aboutUs">
	...
	<c:forEach var="file" items="${filelist}">
		<p id="<c:out value="${file.num}" />">
			...
			<input type="button" value="删除" class="buttonStyle" onClick="javascript:deleteFile('<c:url value="/"/>','<c:out value="${file.num}" />', '删除')" />
			<br />
			<br />
		</p>
	</c:forEach>
