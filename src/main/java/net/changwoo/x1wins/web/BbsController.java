...
//			}
    ...
    public String showNoticeList(Map model, HttpServletRequest request) { 	
    	model.put("menu", menu);
    	int pageNum=1;
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
	@RequestMapping(value = "/fgzd/gjzd", method = RequestMethod.GET)
    public String showGjzd(Map model, HttpServletRequest request) { 	
    	model.put("menu", menu);
		try {
				bbsService.findListAndPaging(7,1, perPage , model, request);
		} catch (Exception e) {
			logger.debug(e.toString());
			model.put("message", e.toString());
			return errorPage;
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    @RequestMapping(value = "/fgzd/xnzd", method = RequestMethod.GET)
    public String showXnzd(Map model, HttpServletRequest request) { 	
    	model.put("menu", menu);
		try {
				bbsService.findListAndPaging(8,1, perPage , model, request);
		} catch (Exception e) {
			logger.debug(e.toString());
			model.put("message", e.toString());
			return errorPage;
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    @RequestMapping(value = "/llyj", method = RequestMethod.GET)
    public String showLlyj(Map model, HttpServletRequest request) { 	
    	model.put("menu", menu);
		try {
				bbsService.findListAndPaging(5,1, perPage , model, request);
		} catch (Exception e) {
			logger.debug(e.toString());
			model.put("message", e.toString());
			return errorPage;
    ...
    public String showXzzq(Map model, HttpServletRequest request) { 	
    	model.put("menu", menu);
		try {
				bbsService.findListAndPaging(9,1, perPage , model, request);
		} catch (Exception e) {
			logger.debug(e.toString());
			model.put("message", e.toString());
			return errorPage;
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
   	@RequestMapping(value = "/wsyy", method = RequestMethod.GET)
       public String showWsyy(Map model, HttpServletRequest request) { 	
       	model.put("menu", menu);
   		try {
   				bbsService.findListAndPaging(10,1, perPage , model, request);
   		} catch (Exception e) {
   			logger.debug(e.toString());
   			model.put("message", e.toString());
   			return errorPage;
